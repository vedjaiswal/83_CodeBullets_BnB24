    ...
    <div className="doctor-section" id="doctors">
      ...
      <div className="md:col-span-2">
        <div className="mt-[50px] border-b border-solid border-[#0066ff34] flex items-start w-1/3">
          <button
            className={` ${tab === "past" &&
              "border-b border-solid border-blue-700"} py-2 px-5 mr-5 text-[16px] leading-7 text-headingColor font-semibold`}
            onClick={() => setTab("past")}
          >
            Past Appointments
          </button>
          <button
            className={` ${tab === "current" &&
              "border-b border-solid border-blue-700"} py-2 px-5 text-[16px] leading-7 text-headingColor font-semibold`}
