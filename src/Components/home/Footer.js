    ...
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:support@wellCare.com">support@wellCare.com</a>
            </li>
            <li>
              <a href="mailto:appointment@wellCare.com">
                appointment@wellCare.com
              </a>
            </li>
            <li>
      ...
      <div className="ft-copyright">
        <p>© 2013-2024 WellCare. All rights reserved.</p>
