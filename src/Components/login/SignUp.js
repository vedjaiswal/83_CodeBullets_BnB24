        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="mt-7">
            <button type="submit" className="btn bg-[#252bdd] text-white w-full px-4 py-3 text-[16px] leading-[30px] rounded-lg">Sign Up</button>
          </div>

          <p className="mt-5 text-textColor text-center">Already have an account? <Link to='/login' className="text-[#343efd] font-medium ml-1">Log In</Link></p>
            </form>
          </div>
        </div>
      </div>
